...
class CartItem extends Equatable {
  ...
  int get priceIncludingImportDuty => (product.shelfPrice + product.importDutyValue) * quantity;

  /// Equatable
  @override
  List<Object> get props => [product, quantity];

  /// Returns one line of a receipt.
  String toReceipt() => '$quantity ${product.name}: ${Money(product.priceIncludingImportDuty).asEuroStringWithSymbol}';
}
